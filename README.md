...
<div align="center">
  <h1>Bidding App</h1>
  <h2>README template pulled from Louis3797</h2>
  
  <p>
    Bidding App created with NextJS and Convex
  </p>
...
To run this project, you will need to add the following environment variables to your .env file
  ...
  # Package to have your .env variables be typed 
  ```
...
#### 1. NextJS
#### 2. Docker
#### 3. Drizzle, Boilerplate db folder
#### 4. env.ts
